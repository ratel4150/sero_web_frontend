...
const LineChart = ({ isDashboard = false, dataChart, tipo, isTotal = false }) => {
  ...
  const line = (
    <Line
      ...
      colors={isTotal ? ['#12fb0a'] : (tipo == 2 ? ['#800303', '#12fb0a', '#ADA7A7'] : ['#800303', '#12fb0a', '#011ded', '#eed312', '#DA251D', '#034004', '#00A5AE', '#ADA7A7'])}
      ...
      useMesh={true}
      legends={screen.width <= 450 ? undefined : [
        {
          anchor: "bottom-right",
          direction: "column",
          justify: false,
          ...
          <>
            ...
            <div style={{ width: '270px', padding: '5px 20px', backgroundColor: '#fffafa', borderRadius: '10px', color: '#000000', textAlign: 'center' }}>
              ...
              <h4 style={{ display: 'inline-block', fontWeight: 'bold', color: '#000000' }}>
                {d.point.serieId} - {d.point.data.xFormatted} - {d.point.data.yFormatted} {!isTotal && '%'} 
              </h4>
            </div>
          </>
        )
